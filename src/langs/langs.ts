...
const ZH = {
    ...
    setting: {
        ...
        "link-format": "链接格式化",
        "link-format-desc": "Markdown链接 (`[]()`)，Wiki链接 (`[[ ]]`)",
        ...
        "path-mode": "转换wikilink为Markdown链接时的路径模式",
        "result-format": "移除选中链接格式的结果",
        "result-format-desc": "与`[{text}]({url})`匹配，使用`{text}`维持文本或`{url}`维持链接。",
        "remove-wikilink-url": "移除WikiLink时也移除URL",
        "wiki-link-format-heading": "带标题的WikiLink格式化",
        ...
        "zotero-output-format": "Zotero注释粘贴到Obsidian中的（输出）格式",
        "zotero-output-format-desc": 
            "变量: \n" +
            "{text}: <文本>,\n" +
            "{pdf_url}: <PDF链接>,\n" +
